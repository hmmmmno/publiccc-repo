...
# ---------- 📁 [ | 𝗣𝗠 𝗙𝗜𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            for files in filedetails:
                ...
                buttons = [[
                  InlineKeyboardButton('🧑‍💻 How To Own 🧑‍💻', url='https://t.me/rangermoviess')
                  ]]                 
...
# ---------- 📁 [ | 𝗠𝗢𝗗𝗨𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            if query.from_user.id not in ADMINS: 
                buttons = [[
                 ...
                 InlineKeyboardButton("🗳 Deploy", url="t.me/Dark_World7_4"),
                 InlineKeyboardButton("🤖 Update", url="https://t.me/rangermoviess")
                 ]]
            else:
                buttons = [[
                 InlineKeyboardButton("➕️ Add me to Your Chat ➕️", url=f"http://t.me/{bot_info.BOT_USERNAME}?startgroup=true")
